...
public class ClienteControlador {
    ...
    public void initialize(){
        ...
        tablaMascotas.getSelectionModel()
                ...
                .addListener((obs,viejo,nuevo)->{
                    ...
                    if (nuevo != null) {
                        if(btnIrHistorial != null) btnIrHistorial.setDisable(false);
                    } else {
                        if(btnIrHistorial != null) btnIrHistorial.setDisable(true);
                    }
                });
    ...
    @FXML
    private void irAHistorialAccion(ActionEvent e){
        if (mascotaSeleccionada != null) {
            MainControlador.getInstancia().abrirHistorialFiltrado(mascotaSeleccionada.getNumeroFicha());
        }
    }
